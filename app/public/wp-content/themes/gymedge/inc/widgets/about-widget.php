		...
		public function widget( $args, $instance ){
			...
			<div class="footer-social-media-area">
					...
					if( !empty( $instance['facebook'] ) ){
						?><span class="margin-right-10px"><a href="<?php echo esc_url( $instance['facebook'] ); ?>" target="_blank"><i class="fa fa-facebook"></i></a></span><?php
					}
					if( !empty( $instance['pinterest'] ) ){
						?><span class="margin-right-10px"><a href="<?php echo esc_url( $instance['pinterest'] ); ?>" target="_blank"><i class="fa fa-pinterest"></i></a></span><?php
					}
					if( !empty( $instance['instagram'] ) ){
						?><span><a href="<?php echo esc_url( $instance['instagram'] ); ?>" target="_blank"><i class="fa fa-instagram"></i></a></span><?php
					}
					?>
			</div> 
