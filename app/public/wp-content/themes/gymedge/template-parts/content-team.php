<div class="bg-pink-50 padding-top-100px">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<!-- header -->
				<?php //if( get_field('home_team_header') ): ?> 
					<h3 class="large-header margin-bottom-20px">
						Meet our team
						<?php the_field('home_team_header');?>
					</h3>
				<?php //endif;?>
				<?php //if( get_field('hero_team_subheader') ): ?> 
					<p class="col-xs-12 col-sm-8 padding-0px sub-header">
						<?php the_field('home_team_subheader');?>
	...
	<div class="container">
		<div class="row rt-team-grid-1 instructor-list-home">
	...
	<div class="container padding-bottom-50px">
		<div class="row">
			<div class="col-xs-12 col-sm-4 padding-0px padding-left-10px">
				<?php //if( get_field('hero_team_sign_up') ): ?> 
					<a class="button button-purple home-hero-button" href="<?php the_field('hero_team_sign_up');?>">
						Sign up for class
					</a>
				<?php //endif;?>
			</div>
